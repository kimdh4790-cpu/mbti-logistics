...
var SUBTITLES_ALL_INFLEARN = {
  A: [
    { from: 0,    to: 150,  text: "카카오 알림톡 자동 발송하는 법" },
    { from: 150,  to: 300,  text: "구글시트 연결하면 혼자 보냅니다" },
    { from: 300,  to: 510,  text: "n8n으로 무료 자동화" },
    { from: 510,  to: 720,  text: "오라클 무료 서버에서 돌리면 비용 0원" },
    { from: 720,  to: 1020, text: "워크플로우 3개 그대로 드려요" },
    { from: 1020, to: 1320, text: "인프런 'n8n 카카오알림톡' 검색" },
    { from: 1320, to: 1560, text: "22,000원 · 평생 소장" },
    { from: 1560, to: 1800, text: "지금 바로 무료 미리보기" },
  ],
  B: [
    { from: 0,    to: 150,  text: "직원 급여 계산 실수 있었나요?" },
    { from: 150,  to: 300,  text: "4대보험 공제 틀리면 다시 해야죠" },
    { from: 300,  to: 510,  text: "이 엑셀은 자동으로 계산해요" },
    { from: 510,  to: 720,  text: "국민연금 건강 고용 지방소득세까지" },
    { from: 720,  to: 1020, text: "명세서 출력도 자동이에요" },
    { from: 1020, to: 1320, text: "인프런 '급여명세서 자동계산' 검색" },
    { from: 1320, to: 1560, text: "19,000원 · 2026년 요율 반영" },
    { from: 1560, to: 1800, text: "지금 바로 무료 미리보기" },
  ],
  C: [
    { from: 0,    to: 150,  text: "부가세 신고 때마다 헷갈리죠?" },
    { from: 150,  to: 300,  text: "납부세액이 자동으로 나와요" },
    { from: 300,  to: 510,  text: "매출 매입 입력만 하면" },
    { from: 510,  to: 720,  text: "SUMIF 수식이 알아서 계산" },
    { from: 720,  to: 1020, text: "연 4회 신고 자동 산출" },
    { from: 1020, to: 1320, text: "인프런 '부가세신고 자동계산' 검색" },
    { from: 1320, to: 1560, text: "25,000원 · 평생 소장" },
    { from: 1560, to: 1800, text: "지금 바로 무료 미리보기" },
  ],
  D: [
    { from: 0,    to: 150,  text: "영수증 연말에 몰아서 처리하세요?" },
    { from: 150,  to: 300,  text: "그게 제일 힘든 일이잖아요" },
    { from: 300,  to: 510,  text: "매달 입력하면 자동 집계돼요" },
    { from: 510,  to: 720,  text: "세금공제 기준도 카테고리에 포함" },
    { from: 720,  to: 1020, text: "연간 경비 한눈에 정리" },
    { from: 1020, to: 1320, text: "인프런 '소상공인 경비장부' 검색" },
    { from: 1320, to: 1560, text: "15,000원 · 가장 실용적인 자료" },
    { from: 1560, to: 1800, text: "지금 바로 무료 미리보기" },
  ],
  E: [
    { from: 0,    to: 150,  text: "서버 비용 매달 나가세요?" },
    { from: 150,  to: 300,  text: "오라클에서 무료로 만드는 법 있어요" },
    { from: 300,  to: 510,  text: "4코어 24GB 영구 무료입니다" },
    { from: 510,  to: 720,  text: "n8n Docker 설치 가이드 포함" },
    { from: 720,  to: 1020, text: "SSH 접속부터 방화벽 설정까지" },
    { from: 1020, to: 1320, text: "인프런 'Oracle Cloud 무료서버' 검색" },
    { from: 1320, to: 1560, text: "22,000원 · 9단계 완전 가이드" },
    { from: 1560, to: 1800, text: "지금 바로 무료 미리보기" },
  ],
  F: [
    { from: 0,    to: 150,  text: "AI한테 물어봐도 답이 안 나오죠?" },
    { from: 150,  to: 300,  text: "프롬프트를 잘못 쓰고 있는 거예요" },
    { from: 300,  to: 510,  text: "소상공인용 프롬프트 100개 드려요" },
    { from: 510,  to: 720,  text: "마케팅 계약 고객응대 공지까지" },
    { from: 720,  to: 1020, text: "[대괄호] 변수만 바꾸면 즉시 완성" },
    { from: 1020, to: 1320, text: "인프런 'AI프롬프트 소상공인' 검색" },
    { from: 1320, to: 1560, text: "29,000원 · 100개 전부 포함" },
    { from: 1560, to: 1800, text: "지금 바로 무료 미리보기" },
  ],
};
...
function InflearnPromo(props) {
  ...
  var SCENES = [
    { component: SceneHook,  start: 0,    duration: 300, extraProps: hookProps },
    { component: SceneClips, start: 300,  duration: 420, extraProps: {} },
    { component: Scene3,     start: 720,  duration: 600, extraProps: scene3Props },
    { component: SceneCTA,   start: 1320, duration: 480, extraProps: {} },
  ];
  return (
