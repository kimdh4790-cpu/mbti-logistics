...
var SUBTITLES_ALL = [
  // A: 야근 → 3분 비밀
  [
    { from: 0,    to: 150,  text: "저도 매달 야근했어요 정산 때문에" },
    { from: 150,  to: 300,  text: "이거 쓰고 나서 3분으로 줄었습니다" },
    { from: 300,  to: 480,  text: "엑셀 한 번 올리면..." },
    { from: 480,  to: 660,  text: "500명 정산이 자동으로 완료" },
    { from: 660,  to: 840,  text: "그 즉시 알림톡도 전원 발송" },
    { from: 840,  to: 1020, text: "기사들이 먼저 확인 문자를 보내요" },
    { from: 1020, to: 1200, text: "기사 1인당 2,500원이에요" },
    { from: 1200, to: 1380, text: "이 가격에 이게 된다고?" },
    { from: 1380, to: 1800, text: "donway.ai.kr 7일 무료체험" },
  ],
  // B: 기사들이 먼저 연락하는 이유
  [
    { from: 0,    to: 150,  text: "기사들이 정산 연락을 먼저 해요" },
    { from: 150,  to: 300,  text: "이유가 뭔지 아세요?" },
    { from: 300,  to: 480,  text: "정산 완료되는 즉시..." },
    { from: 480,  to: 660,  text: "카카오로 명세서가 자동 발송돼요" },
    { from: 660,  to: 840,  text: "기사 입장에선 투명한 거잖아요" },
    { from: 840,  to: 1020, text: "이의제기가 0건이 됐어요" },
    { from: 1020, to: 1200, text: "300명 동시 발송이 3초면 끝나요" },
    { from: 1200, to: 1380, text: "기사 신뢰 = 매출로 직결됩니다" },
    { from: 1380, to: 1800, text: "donway.ai.kr 무료체험 가능" },
  ],
  // C: 이 실수가 기사 이탈 1위
  [
    { from: 0,    to: 150,  text: "기사 이탈 이유 1위 아세요?" },
    { from: 150,  to: 300,  text: "정산 오류입니다" },
    { from: 300,  to: 480,  text: "DONWAY는 자동으로 검증해요" },
    { from: 480,  to: 660,  text: "입력값 이상하면 바로 경고" },
    { from: 660,  to: 840,  text: "오류 0건 · 이의제기 0건" },
    { from: 840,  to: 1020, text: "기사들이 오래 남는 이유예요" },
    { from: 1020, to: 1200, text: "기사 1인당 2,500원으로" },
    { from: 1200, to: 1380, text: "신뢰를 살 수 있어요" },
    { from: 1380, to: 1800, text: "donway.ai.kr 7일 무료체험" },
  ],
  // D: 왜 갑자기 다들 쓰냐면
  [
    { from: 0,    to: 150,  text: "배달대행 소장님들 사이에서" },
    { from: 150,  to: 300,  text: "갑자기 이게 뜨는 이유 있어요" },
    { from: 300,  to: 480,  text: "경쟁사 대비 절반 가격인데" },
    { from: 480,  to: 660,  text: "기능은 똑같거든요" },
    { from: 660,  to: 840,  text: "엑셀 정산 · 알림톡 · 세금계산서" },
    { from: 840,  to: 1020, text: "전부 포함이에요" },
    { from: 1020, to: 1200, text: "50명이면 12만5천원" },
    { from: 1200, to: 1380, text: "모르면 손해 보는 거잖아요" },
    { from: 1380, to: 1800, text: "donway.ai.kr 7일 무료" },
  ],
];
...
function DonwayPromo(props) {
  ...
  var SCENES = [
    { component: SceneIntro,    start: 0,    duration: 300 },
    { component: SceneExcel,    start: 300,  duration: 360 },
    { component: SceneAlimtalk, start: 660,  duration: 360 },
    { component: ScenePricing,  start: 1020, duration: 360 },
    { component: SceneCTA,      start: 1380, duration: 420 },
  ];
  return (
