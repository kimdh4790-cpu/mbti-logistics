...
var SUBTITLES_ALL = [
  ...
  [
    ...
    { from: 1380, to: 1800, text: "서비스 오픈 준비중 · yongcha.app" },
  ],
...
function YongchaPromo(props) {
  ...
  var SCENES = [
    { component: SceneHook,     start: 0,    duration: 300 },
    { component: SceneMatching, start: 300,  duration: 360 },
    { component: SceneAI,       start: 660,  duration: 360 },
