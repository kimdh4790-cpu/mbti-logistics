...
| 4 | `[-]` | 팝빌 역발행 테스트 → 운영전환 신청 | _worker.js | 2026-09-22 error 1016 수정 완료(ID 필드·하이픈·trim). 공동인증서 등록 필요 — MagicLine4NX 설치 실패(DLL 오류) + 하드디스크 인증서 파일 못 찾음. 박주선 팀장(010-5330-0078)에 문의 발송 완료(2026-09-22). 답변 후 재진행. |
