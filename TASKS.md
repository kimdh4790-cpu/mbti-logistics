...
| 2 | `[-]` | 팝빌 키 발급 → Cloudflare Secret 등록 → 역발행 실전 테스트 | _worker.js | 박주선 팀장(010-5330-0078 / jooseon@linkhubcorp.com) 연락 → LinkID+SecretKey 수신 → wrangler secret put 3개 등록 → 테스트. 요금: **50원/건**, 은행조회 8원/건. 코드 완성됨 키만 대기. |
