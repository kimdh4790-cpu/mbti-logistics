...
var MODALS={
  ...
  stock_out:{
    ...
    body:function(){return '<div class="feat-list"><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">재고 자동 차감</div><div class="feat-row-desc">출고 수량 입력 즉시 재고 현황 자동 업데이트. 실시간 재고 정확도 유지</div></div></div><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">최소재고 경고</div><div class="feat-row-desc">출고 후 재고가 최소 기준 이하로 떨어지면 즉시 경고. 품절 사전 방지</div></div></div><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">출고 사유 기록</div><div class="feat-row-desc">판매/폐기/이동 등 출고 사유 분류 기록. 폐기 현황 분석으로 낭비 절감</div></div></div><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">입출고 통합 원장</div><div class="feat-row-desc">입고·출고 이력을 하나의 원장에서 조회. 재고 흐름 전체 추적 가능</div></div></div></div>';}
  },
  auto_order:{
    ic:'',color:'rgba(201,168,76,.15)',border:'rgba(201,168,76,.3)',
    title:'자동 발주',tagline:'최소 재고 도달 시 자동으로 발주 알림 발송',
    body:function(){return '<div class="feat-list"><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">최소재고 기준 설정</div><div class="feat-row-desc">품목별 최소재고 기준 설정. 기준 이하로 떨어지면 자동 감지 후 알림 발송</div></div></div><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">카카오 알림톡 발주 알림</div><div class="feat-row-desc">발주 필요 품목, 거래처 정보, 추천 발주 수량이 포함된 알림 자동 발송</div></div></div><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">발주 이력 관리</div><div class="feat-row-desc">언제, 어떤 품목을, 얼마나 발주했는지 자동 기록. 발주 패턴 분석 가능</div></div></div><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">거래처 정보 연동</div><div class="feat-row-desc">품목별 담당 거래처 등록. 발주 알림에 거래처 연락처 자동 포함</div></div></div></div>';}
  },
  expiry:{
    ic:'',color:'rgba(239,68,68,.15)',border:'rgba(239,68,68,.3)',
    title:'유통기한 관리',tagline:'D-7 경고로 폐기 손실을 사전에 방지',
    body:function(){return '<div class="feat-list"><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">D-7 자동 경고</div><div class="feat-row-desc">유통기한 7일 전부터 경고 표시. 만료 임박 품목 우선 사용으로 폐기 최소화</div></div></div><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">입고 시 유통기한 등록</div><div class="feat-row-desc">입고 등록 시 유통기한 함께 기록. 자동 D-day 계산으로 매일 확인 불필요</div></div></div><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">만료 예정 목록</div><div class="feat-row-desc">이번 주 만료 예정 품목 자동 정렬. 메인 대시보드에 경고 카드로 즉시 표시</div></div></div><div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">폐기 처리 기록</div><div class="feat-row-desc">만료 품목 폐기 등록으로 재고 자동 차감. 월별 폐기 손실 금액 자동 집계</div></div></div></div>';}
  },
  recipe:{
    ic:'',color:'rgba(201,168,76,.15)',border:'rgba(201,168,76,.3)',
    ...
    body:function(){return '<div class="mini-stat-row">'+
      ...
      '<div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">재고 부족 푸시알림</div><div class="feat-row-desc">재고 하한선 설정 → 부족 시 브라우저 푸시알림 자동 발송</div></div></div>'+
      '</div>';}
  },dine_sync:{
    ic:'',color:'rgba(8,145,178,.15)',border:'rgba(8,145,178,.3)',
    ...
    body:function(){return '<div class="feat-list">'+
      ...
      '<div class="feat-row"><div class="feat-row-ic"></div><div class="feat-row-body"><div class="feat-row-title">재고부족 DINE 알림</div><div class="feat-row-desc">FILO 재고 부족 → DINE 대시보드 즉시 알림</div></div></div>'+
