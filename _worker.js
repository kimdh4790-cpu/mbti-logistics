    ...
    if (hostname === 'filo.ai.kr' || hostname === 'www.filo.ai.kr') {
      ...
      if (path === '/api/menus') {
        ...
        const IMG_MAP = {
          ...
          '양념':'https://images.unsplash.com/photo-1608039755401-742074f0548d?w=500&q=80&fm=jpg&crop=entropy&fit=crop',
          '뿌링':'https://images.unsplash.com/photo-1626645738196-c2a7c87a8f58?w=500&q=80&fm=jpg&crop=entropy&fit=crop',
          '콤보':'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=500&q=80&fm=jpg&crop=entropy&fit=crop',
